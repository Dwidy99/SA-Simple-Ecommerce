	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			<div class="col-md-4 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						...
						<ul class="slides">
							<li class="titik" data-thumb="<?= base_url('assets/images/'. $detail["tshirt_image"]); ?>">
								<div class="thumb-image"> <img src="<?= base_url('assets/images/'.$detail['tshirt_image']); ?>" data-imagezoom="true" class="img-responsive"> </div>
							</li>
			...
			<div class="col-md-8 single-right-left simpleCart_shelfItem">
				<h3></h3>
				<p><span class="item_price">Rp. <?= number_format($detail['tshirt_price'], 2,", ", "."); ?></span> <del>Rp. <?= number_format($detail['harga_coret'], 2,", ", "."); ?></del></p>
				<div class="rating1">
				...
				<div class="resp-tabs-container">
					...
					<div class="tab1">
						...
						<div class="single_page_agile_its_w3ls">
							...
							<p class="w3ls_para"><?= $detail["product_description"]; ?></p>
						</div>
					</div>
					<!--//tab_one-->
					<div class="tab2">
							...
							<div class="bootstrap-tab-text-grids">
								<div class="bootstrap-tab-text-grid">
									<div class="bootstrap-tab-text-grid-left">
										<img src="<?= base_url('assets/images/'); ?>t1.jpg" alt=" " class="img-responsive">
									</div>
