				...
				<div class="col-md-4 product-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="<?= base_url('assets/images/'.$row['tshirt_image']); ?>" alt="<?= $row['tshirt_name']; ?>" class="pro-image-front">
							<img src="<?= base_url('assets/images/'.$row['tshirt_image']); ?>" alt="<?= $row['tshirt_name']; ?>" class="pro-image-back">
						...
						<div class="item-info-product ">
							...
							<div class="info-product-price">
								<span class="item_price">Rp. <?= $row['tshirt_price']; ?></span><br>
								<del>Rp. <?= $row['harga_coret']; ?></del>
							</div>
