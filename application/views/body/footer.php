      ...
      <div class="col-md-9 footer-right">
         <div class="sign-grds">
            ...
            <div class="col-md-3 sign-gd flickr-post">
               ...
               <ul>
                  <li><a href="single.html"><img src="<?= base_url('assets/'); ?>images/t1.jpg" alt=" "
                           class="img-responsive" /></a></li>
                  <li><a href="single.html"><img src="<?= base_url('assets/'); ?>images/t2.jpg" alt=" "
                           class="img-responsive" /></a></li>
                  <li><a href="single.html"><img src="<?= base_url('assets/'); ?>images/t3.jpg" alt=" "
                           class="img-responsive" /></a></li>
                  <li><a href="single.html"><img src="<?= base_url('assets/'); ?>images/t4.jpg" alt=" "
                           class="img-responsive" /></a></li>
                  <li><a href="single.html"><img src="<?= base_url('assets/'); ?>images/t1.jpg" alt=" "
                           class="img-responsive" /></a></li>
                  <li><a href="single.html"><img src="<?= base_url('assets/'); ?>images/t2.jpg" alt=" "
...
<script>
$(document).ready(function() {
   $.get("<?= site_url('Checkout/get_provinsi') ?>", {},
      (response) => {
         let output = '';
...
$(window).on('load', function() {
   $.get("<?= site_url('Checkout/get_kota/') ?>" + 3, {},
      (response) => {
         let output = '';
...
function get_kota_tujuan() {
   ...
   $.get("<?= site_url('Checkout/get_kota/') ?>" + id_provinsi, {},
      function(response) {
         let output = '<option value="" selected>-- pilih --</option>';
...
function get_ongkir() {
   ...
   $.get("<?= site_url('Checkout/get_ongkir/'); ?>" + asal + "/" + tujuan + "/" + berat + "/" + kurir, {},
      (response) => {
         ...
         biaya.map((val, i) => {
            ...
            for (let i = 0; i < val.costs.length; i++) {
               const jenis_layanan = val.costs[i].service;
               val.costs[i].cost.map((val, i) => {
                  output +=
                     `<option data-ongkir="${val.value}" value="${val.value}">${jenis_layanan}--Rp. ${val.value} ${val.etd} Hari</option>`;
                  price = val.value;
               })
            }
         })
...
function get_harga(event) {
   ...
   let tot_order = Number($("#tot_order").text());
